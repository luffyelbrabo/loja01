                ...
                <div class="row">
                    <div class="col">
                        <div class="dropdown">
                            ...
                            <button class="btn btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#modal-excluir-todas-payloads"><i class="fa-solid fa-trash"></i> Excluir todas</button>
      ...
      <div class="modal-footer">
        <form action="" method="post">
          ...
          <button type="submit" class="btn btn-danger" name="delete_all">Excluir todas</button>
                    ...
                    <div class="col">
                        <div class="col"><button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#modal-sms"><i class="fa-solid fa-sms"></i>
                    </div>
                    <div class="col">
